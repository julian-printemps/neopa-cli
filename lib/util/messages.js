...
module.exports = function(projectName,messageFramework,messageTemplate) {
  return {
    helloYeti: [
      'Thanks for using Neopa boilerplate for %s!',
      '-------------------------------------------',
    ...
    installSuccessFinal: "\nNow run " + "neopa watch ".cyan + "while inside the " + projectName.cyan + " folder.\n",
    installFailFinal: "\nOnce you've resolved the above issues, run " + "neopa watch ".cyan + "while inside the " + projectName.cyan + " folder.\n"
  }
}
