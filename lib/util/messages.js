...
module.exports = function(projectName,messageFramework,messageTemplate) {
  return {
    helloYeti: [
      'Thanks for using Neopa boilerplate with %s!',
      '----------------------------------',
      'Let\'s set up a new project.',
      'It shouldn\'t take more than five minute.'
    ],
    ...
    gitCloneError: "There was an issue running " + "git clone ".cyan + "to download the framework " + "Neopa boilerplate with ".cyan + messageFramework.cyan + ".\nMake sure your computer's Git is configured properly and then try again.",
    ...
    installSuccessFinal: "\nNow run " + "npm run dev ".cyan + "while inside the " + projectName.cyan + " folder.\n",
    installFailFinal: "\nOnce you've resolved the above issues, run " + "npm run dev ".cyan + "while inside the " + projectName.cyan + " folder.\n"
  }
}
