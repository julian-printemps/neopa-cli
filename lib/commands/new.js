...
var repositories = {
  // bulma: 'git@gitlab.neopa.jp:neopa/neopa-boilerplate-bulma.git',
  foundation: 'git@gitlab.neopa.jp:neopa/neopa-boilerplate-foundation.git',
  admin: 'git@gitlab.neopa.jp:neopa/neopa-admin-boilerplate.git'
}
...
module.exports = function(args, options, callback, ee) {
  ...
  function gitClone(cb) {
    var repo = repositories[framework];
